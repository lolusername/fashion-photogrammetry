...
export const PUBLIC_THEMES: readonly PublicThemeDefinition[] = [
  {
    ...
    provenance: 'Pre-redesign chromatic Invisible Cities branch',
    textureMode: 'mew-holo',
    cycloramaColor: 0x8efff3,
    sceneColor: 0x8bf4ff,
    fogColor: 0xbaffef,
    paperRollColor: 0xf4fff3,
    shadowColor: 0x3b6672,
    shadowOpacity: 0.14,
    cycloramaRoughness: 0.54,
    cycloramaMetalness: 0,
    cycloramaEnvMapIntensity: 0.2,
    yellowBackingVisible: false,
    yellowBackingColor: TECHNICOLOR_YELLOW,
    swatch: 'linear-gradient(135deg, #98f5ff 0%, #b8f46d 35%, #ffb1da 68%, #fff35e 100%)',
    stageTop: '#c9fbff',
    stageMiddle: '#8af4ff',
    stageBottom: '#97ef62',
    stageGlow: 'rgba(255, 242, 54, 0.54)',
    stageEdge: 'rgba(255, 93, 184, 0.16)',
    stageVignette: 'rgba(111, 72, 184, 0.18)',
  },
  {
    id: 'blue',
    route: 'dialectic',
